    ...
    return (
        <section className="bg-[url('/images/hero-banner.png')] bg-cover bg-center md:h-[680] md:pt-16 md:pb-20 pt-10 overflow-hidden">
            ...
            <div className='max-w-[949] text-white mx-auto text-center py-14'>
                ...
                <p className='text-[20px] md:text-[25px] max-w-[718] mx-auto mb-7 leading-[144%]' data-aos="fade-up" data-aos-delay="200">When units are clear, mistakes drop, cycle counts shrink, and profit improves.</p>
