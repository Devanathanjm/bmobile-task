    ...
    return (
        <section className="bg-[url('/images/hero-banner.png')] bg-cover bg-center md:h-[680] md:pt-16 md:pb-20 pt-10 overflow-hidden">
            ...
            <div className='max-w-[949] text-white mx-auto text-center py-14'>
                <h1 className='text-[36px] md:text-[70px] leading-[132%] font-semibold mb-7'> <span className='bg-[linear-gradient(90deg,#71BF44_16.83%,#6FC1FF_67.79%,#71BF44_100%)] bg-clip-text text-transparent' data-aos="fade-up" data-aos-duration="400"> Inventory that speaks</span>  your
